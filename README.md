...
10. **Report** — `claim.head` / `demo123` → Report. Claims in the snapshot are grouped: each block shows registration no., FNOL, claimant, stage, score, and last change. Under that, V0–V5 with date, who changed it, and what changed. Click a version for the detail pop-up.
